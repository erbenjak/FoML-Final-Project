...
class CoinRlModel:
    ...
    def convert_state_to_features(self, state, logger):
        ...
        encoded_state = np.append(encoded_state, self.calc_direction_coin(pos_agent, coins, field))
    ...
    @staticmethod
    def calc_direction_coin(pos_agent, coins, field):
    ...
    def create_qtable(self):
        ...
        here we need 2187 rows, since there are 5 features which all can hold 3 different values
            -> 3^6 = 729
    ...
    def state_to_index(state):
        ...
        """
        temp = np.dot((state + 1), np.array([243, 81, 27, 9, 3, 1]))
